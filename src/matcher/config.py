...
# Alignment overlap tolerance for grouping (0.05 = 5%)
# Matches whose ref coverage overlaps by less than this are considered compatible
ALIGNMENT_OVERLAP_TOLERANCE = 0.05
