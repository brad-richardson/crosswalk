...
classifier :func:`crosswalk.config.is_sliver_edge`. All consumers (the stitching
...
def edge_overlap_m(
    ...
    Thin geometry-aware wrapper over :func:`crosswalk.config.sliver_overlap_m` — the
