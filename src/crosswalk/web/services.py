"""Service layer for the crosswalk web UI.
...
# Project root: src/crosswalk/web/services.py -> project root is 3 levels up
...
def generate_batch(
    ...
    if matcher is None:
        raise ValueError("No ML model available. Train a model first with 'crosswalk train'.")
