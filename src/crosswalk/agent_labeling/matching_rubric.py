...
MATCHING_RUBRIC_VERSION = "2026-07-14"
CANONICAL_RULES_DOC = "docs/MATCHING_MERGING_RULES.md"

MATCH_IDENTITY_RUBRIC = """CANONICAL MATCH-IDENTITY RUBRIC (version 2026-07-14)
...
PAIR_LABEL_RUBRIC = """PAIR-LABEL OUTPUT CONTRACT (version 2026-07-14)
...
STITCH_ASSIGNMENT_RUBRIC = """STITCH-ASSIGNMENT OUTPUT CONTRACT (version 2026-07-14)
