...
- The deferred identities behind that quarantine and the 14 retained split-provenance omission keys are pinned in [`stitching_deferred_audit.md`](stitching_deferred_audit.md); they remain TODOs and do not change the fail-closed benchmark truth.
