"""Tests for mbench CLI path resolution.
...
datasets.toml file's directory, not the process CWD, so mbench works from any
...
from mbench.cli import _resolve_config_default, _resolve_single_run_paths
