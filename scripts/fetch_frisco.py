...
Output files will be saved to:
    - data/raw/us_frisco_trails.parquet
    - data/raw/us_frisco_roads.parquet
"""
...
# Frisco datasets to fetch (using new country-prefixed names)
FRISCO_DATASET_NAMES = [
    "us_frisco_trails",
    "us_frisco_roads",
]
...
def main():
    ...
    for dataset_name in FRISCO_DATASET_NAMES:
