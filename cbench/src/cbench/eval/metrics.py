...
def evaluate(predictions: pd.DataFrame, labels: pd.DataFrame) -> EvalResult:
    ...
    """
    # Build ground truth sets (vectorized for performance)
    ...
    # Build prediction set (duplicates are collapsed)
    predicted_set = set(
